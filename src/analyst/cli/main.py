...
from .reports import report_ai_rollout, report_job_pipeline, report_takehome_snapshot, report_takehome_statistics, blocked_interview_snapshot
...
analyst.add_command(report_takehome_statistics, name="report-takehome-statistics")
analyst.add_command(blocked_interview_snapshot, name="blocked-interview-snapshot")
